...
<body>
  ...
  <div class="share-footer">
    ...
    <div class="share-btns">
      <a class="btn-fb-big" href="https://www.facebook.com/sharer/sharer.php?u=https://lucie-app-5fea0268.base44.app/Mohawks" target="_blank">📘 Facebook</a>
      <a class="btn-group-big" href="https://www.facebook.com/groups/1451283625021958" target="_blank">👥 Groupe FB</a>
      <a class="btn-messenger-big" href="https://www.facebook.com/dialog/send?link=https://lucie-app-5fea0268.base44.app/Mohawks&app_id=291494419107518&redirect_uri=https://lucie-app-5fea0268.base44.app/Mohawks" target="_blank">💬 Messenger</a>
      <a class="btn-whatsapp-big" href="https://api.whatsapp.com/send?text=D%C3%A9couvre+cet+article+sur+les+Mohawks+%3A+https://lucie-app-5fea0268.base44.app/Mohawks" target="_blank">🟢 WhatsApp</a>
      <a class="btn-email-big" href="mailto:?subject=Article+sur+les+Mohawks&body=Je+te+partage+cet+article+sur+les+Mohawks+%3A+https://lucie-app-5fea0268.base44.app/Mohawks" target="_blank">📧 Courriel</a>
      <button class="btn-copy-big" onclick="navigator.clipboard.writeText('https://lucie-app-5fea0268.base44.app/Mohawks').then(function(){var t=document.getElementById('toast-share');t.style.opacity='1';t.style.transform='translateX(-50%) translateY(0)';setTimeout(function(){t.style.opacity='0';t.style.transform='translateX(-50%) translateY(20px)';},2500);})">🔗 Copier le lien</button>
    </div>
  </div>
